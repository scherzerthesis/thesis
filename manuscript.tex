This manuscript
(\href{https://scherzerthesis.github.io/thesis/v/cfeaf4b301d421f38362c16fb408e8a598ee88be/}{permalink})
was automatically generated
from \href{https://github.com/scherzerthesis/thesis/tree/cfeaf4b301d421f38362c16fb408e8a598ee88be}{scherzerthesis/thesis@cfeaf4b}
on April 6, 2022.
...
\caption{\textbf{Figure 3.1.Cre-mediated wildtype-to-mutant alleles used in study.} (A) Priot to Cre-mediated recombination, normal \emph{Braf} and \emph{Trp53} are expressed from their endogenous loci. (B) After Cre-mediated recombination, the indicated mutant proteins are expressed, in addition to a TdTomato fluorescent protein to mark expression of BRAF\textsuperscript{V600E}.}\label{fig:3.1}
}
\end{figure}
...
\caption{\textbf{Figure 3.7. Mouse tumors and cell lines that expression P53-R172H and p53-R245W are refractory to MAPK blockade.} (A) Tumor burden analysis of GEMMs treated with MAPKi chow for four weeks. (B) \emph{n vitro} dose response to dabrafenib for 48 hours. (C) Western blots of timecourse of cell lines treated with dabrafenib plus trametinib.}\label{fig:3.7}
}
\end{figure}
...
Since there is great interest in p53-mediated tumor supression, we wondered if we could detect a p53-gene signature in our data set. Indeed, we did detect the reduction of transcripts that are often associated with p53 transcriptional activation in reponse to p53-mutation, such as downregulation of \emph{Cdkn1a}, \emph{Zmat3}, and \emph{CCng1}(Figure 4.6A). Furthermore, P53-target gene expression is maintained only in p53 wildtpype samples, including \emph{Cdkn2a} loss (Figure 4.6B). Therefore we have successful identified a p53-gene signature in \_BRAF\textsuperscript{V600E} expressing lung tumors using scRNA sequncing.
...
\caption{\textbf{Figure 4.1. 71,110 cells collected from different genotypes.}}\label{fig:04}
}
\end{figure}
...
\caption{\textbf{Figure 4.7. Genotpye-specific gene expression changes.}}\label{fig:04}
}
\end{figure}
