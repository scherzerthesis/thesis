This manuscript
(\href{https://scherzerthesis.github.io/thesis/v/9213662b7adaf086956a4d1fa83ad98751f19610/}{permalink})
was automatically generated
from \href{https://github.com/scherzerthesis/thesis/tree/9213662b7adaf086956a4d1fa83ad98751f19610}{scherzerthesis/thesis@9213662}
on March 15, 2022.
...
\hypertarget{fig:14}{%
\centering
\includegraphics{images/p53_5.png}
...
\hypertarget{fig:14}{%
\centering
\includegraphics{images/p53_6.png}
\caption{\textbf{Mutant-p53 expression cells have distinct transcriptome compared to p53-null cells.} \textbf{(A)} Volcano plot of differentially-expressed genes. \textbf{(B)} Upregulated pathways using GSEA with Hallmark gene sets.}\label{fig:14}
}
\end{figure}
...
\hypertarget{fig:14}{%
\centering
\includegraphics{images/p53_7.png}
\caption{\textbf{Mutant-p53 expression cells have distinct transcriptome compared to p53-null cells.} \textbf{(A)} Volcano plot of differentially-expressed genes. \textbf{(B)} Upregulated pathways using GSEA with Hallmark gene sets.}\label{fig:14}
}
\end{figure}
...
\hypertarget{fig:14}{%
\centering
\includegraphics{images/p53_8.png}
\caption{\textbf{Mutant-p53 expression cells have distinct transcriptome compared to p53-null cells.} \textbf{(A)} Volcano plot of differentially-expressed genes. \textbf{(B)} Upregulated pathways using GSEA with Hallmark gene sets.}\label{fig:14}
}
\end{figure}
